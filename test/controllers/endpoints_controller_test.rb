...
class EndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endpoint" do
    assert_difference("Endpoint.count") do
      post endpoints_url, params: { endpoint: { endpoint_title: @endpoint.endpoint_title } }
    end
  ...
  test "should update endpoint" do
    patch endpoint_url(@endpoint), params: { endpoint: { endpoint_title: @endpoint.endpoint_title } }
